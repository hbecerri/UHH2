...
//--------Unfold----------??
    ...
    string  hdampUp = "(weight_sfmu_HighPtID)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag)*(muonrecSF_nominal)*1.08";
    string  hdampDown = "(weight_sfmu_HighPtID)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag)*(muonrecSF_nominal)*1.08";
...
Ttbar_1_pileupUp->Sumw2();
Ttbar_2_pileupUp->Sumw2();
Ttbar_1_muIDUp->Sumw2();
Ttbar_2_muIDUp->Sumw2();
Ttbar_1_muHLTUp->Sumw2();
Ttbar_2_muHLTUp->Sumw2();
Ttbar_1_Top_pT_rewUp->Sumw2();
Ttbar_2_Top_pT_rewUp->Sumw2();
Ttbar_1_mistagUp->Sumw2();
Ttbar_2_mistagUp->Sumw2();
Ttbar_1_toptagUp->Sumw2();
Ttbar_2_toptagUp->Sumw2();
Ttbar_1_muon_recUp->Sumw2();
Ttbar_2_muon_recUp->Sumw2();
Ttbar_1_ISRUp->Sumw2();
Ttbar_2_ISRUp->Sumw2();
Ttbar_1_FSRUp->Sumw2();
Ttbar_2_FSRUp->Sumw2();

Ttbar_1_jectimeptetaUp->Sumw2();
Ttbar_2_jectimeptetaUp->Sumw2();
Ttbar_1_jecRelativeStatHFUp->Sumw2();
Ttbar_2_jecRelativeStatHFUp->Sumw2();
Ttbar_1_jecRelativeStatECUp->Sumw2();
Ttbar_2_jecRelativeStatECUp->Sumw2();
Ttbar_1_jecRelativeStatFSRUp->Sumw2();
Ttbar_2_jecRelativeStatFSRUp->Sumw2();
Ttbar_1_jecRelativeSampleUp->Sumw2();
Ttbar_2_jecRelativeSampleUp->Sumw2();
Ttbar_1_jecRelativePtEC1Up->Sumw2();
Ttbar_2_jecRelativePtEC1Up->Sumw2();
Ttbar_1_jecRelativePtEC2Up->Sumw2();
Ttbar_2_jecRelativePtEC2Up->Sumw2();
Ttbar_1_jecRelativeJEREC2Up->Sumw2();
Ttbar_2_jecRelativeJEREC2Up->Sumw2();
Ttbar_1_jecRelativeJEREC1Up->Sumw2();
Ttbar_2_jecRelativeJEREC1Up->Sumw2();
Ttbar_1_jecAbsoluteStatUp->Sumw2();
Ttbar_2_jecAbsoluteStatUp->Sumw2();


Ttbar_1_jerUp->Sumw2();
Ttbar_2_jerUp->Sumw2();
Ttbar_1_hdampUp->Sumw2();
Ttbar_2_hdampUp->Sumw2();

Ttbar_1_btag_HF_corrUp->Sumw2();
Ttbar_2_btag_HF_corrUp->Sumw2();
Ttbar_1_btag_LF_corrUp->Sumw2();
Ttbar_2_btag_LF_corrUp->Sumw2();
Ttbar_1_btag_HF_unc18Up->Sumw2();
Ttbar_2_btag_HF_unc18Up->Sumw2();
Ttbar_1_btag_LF_unc18Up->Sumw2();
Ttbar_2_btag_LF_unc18Up->Sumw2();

Ttbar_1_pileupDown->Sumw2();
Ttbar_2_pileupDown->Sumw2();
Ttbar_1_muIDDown->Sumw2();
Ttbar_2_muIDDown->Sumw2();
Ttbar_1_muHLTDown->Sumw2();
Ttbar_2_muHLTDown->Sumw2();
Ttbar_1_Top_pT_rewDown->Sumw2();
Ttbar_2_Top_pT_rewDown->Sumw2();
Ttbar_1_mistagDown->Sumw2();
Ttbar_2_mistagDown->Sumw2();
Ttbar_1_toptagDown->Sumw2();
Ttbar_2_toptagDown->Sumw2();
Ttbar_1_muon_recDown->Sumw2();
Ttbar_2_muon_recDown->Sumw2();
Ttbar_1_ISRDown->Sumw2();
Ttbar_2_ISRDown->Sumw2();
Ttbar_1_FSRDown->Sumw2();
Ttbar_2_FSRDown->Sumw2();

Ttbar_1_jectimeptetaDown->Sumw2();
Ttbar_2_jectimeptetaDown->Sumw2();
Ttbar_1_jecRelativeStatHFDown->Sumw2();
Ttbar_2_jecRelativeStatHFDown->Sumw2();
Ttbar_1_jecRelativeStatFSRDown->Sumw2();
Ttbar_2_jecRelativeStatFSRDown->Sumw2();
Ttbar_1_jecRelativeStatECDown->Sumw2();
Ttbar_2_jecRelativeStatECDown->Sumw2();
Ttbar_1_jecRelativeSampleDown->Sumw2();
Ttbar_2_jecRelativeSampleDown->Sumw2();
Ttbar_1_jecRelativePtEC1Down->Sumw2();
Ttbar_2_jecRelativePtEC1Down->Sumw2();
Ttbar_1_jecRelativePtEC2Down->Sumw2();
Ttbar_2_jecRelativePtEC2Down->Sumw2();
Ttbar_1_jecRelativeJEREC2Down->Sumw2();
Ttbar_2_jecRelativeJEREC2Down->Sumw2();
Ttbar_1_jecRelativeJEREC1Down->Sumw2();
Ttbar_2_jecRelativeJEREC1Down->Sumw2();
Ttbar_1_jecAbsoluteStatDown->Sumw2();
Ttbar_2_jecAbsoluteStatDown->Sumw2();

Ttbar_1_jerDown->Sumw2();
Ttbar_2_jerDown->Sumw2();
Ttbar_1_hdampDown->Sumw2();
Ttbar_2_hdampDown->Sumw2();

Ttbar_1_btag_HF_corrDown->Sumw2();
Ttbar_2_btag_HF_corrDown->Sumw2();
Ttbar_1_btag_LF_corrDown->Sumw2();
Ttbar_2_btag_LF_corrDown->Sumw2();
Ttbar_1_btag_HF_unc18Down->Sumw2();
Ttbar_2_btag_HF_unc18Down->Sumw2();
Ttbar_1_btag_LF_unc18Down->Sumw2();
Ttbar_2_btag_LF_unc18Down->Sumw2();
