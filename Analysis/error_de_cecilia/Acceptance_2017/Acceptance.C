...
void Acceptance(string var_weight = "ISRup", int aa = 1)
{
...
//array for variable 
    ...
    cout  << (Acc_antes_electron_nominal->GetBinContent(2) -Acc_antes_electron_nominal->GetBinContent(1))/(Acc_antes_electron_nominal->GetBinContent(2)+Acc_antes_electron_nominal->GetBinContent(1)); 
}
