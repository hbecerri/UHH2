...
void Charge_750_2017(string var_weight = "1", int aa = 1)
{
...
//array for variable 
    ...
    cout << (Acc_antes_muon_nominal_750->GetBinContent(2) - Acc_antes_muon_nominal_750->GetBinContent(1))/(Acc_antes_muon_nominal_750->GetBinContent(2) + Acc_antes_muon_nominal_750->GetBinContent(1));
    cout << (Acc_antes_muon_nominal_750_900->GetBinContent(2) - Acc_antes_muon_nominal_750_900->GetBinContent(1))/(Acc_antes_muon_nominal_750_900->GetBinContent(2) + Acc_antes_muon_nominal_750_900->GetBinContent(1));
