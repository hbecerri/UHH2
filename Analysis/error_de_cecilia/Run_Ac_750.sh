...
text2workspace.py Ac_750.txt -o Ac_750.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_1:r_neg[1,0,20]' --PO map='.*/Ttbar_2:r_pos=expr;;r_pos("67566/68556*@0*(100+@1)/(100-@1)",r_neg,Ac[-2,-5,0])' --PO verbose 
text2workspace.py Ac_900.txt -o Ac_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_1:r_neg[1,0,20]' --PO map='.*/Ttbar_2:r_pos=expr;;r_pos("35668/36268*@0*(100+@1)/(100-@1)",r_neg,Ac[-2,-5,0])' --PO verbose
text2workspace.py Ac_750_900.txt -o Ac_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_1:r_neg[1,0,20]' --PO map='.*/Ttbar_2:r_pos=expr;;r_pos("31898/32288*@0*(100+@1)/(100-@1)",r_neg,Ac[-2,-5,0])' --PO verbose
text2workspace.py Ac_muon.txt -o Ac_muon.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_1:r_neg[1,0,20]' --PO map='.*/Ttbar_2:r_pos=expr;;r_pos("53289/54105*@0*(100+@1)/(100-@1)",r_neg,Ac[-2,-5,0])' --PO verbose
text2workspace.py Ac_ele.txt -o Ac_ele.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_1:r_neg[1,0,20]' --PO map='.*/Ttbar_2:r_pos=expr;;r_pos("14277/14541*@0*(100+@1)/(100-@1)",r_neg,Ac[-2,-5,0])' --PO verbose
...
mv impacts.json impacts_750_900.json
...
mv impacts.json impacts_ele.json
