...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    //jer
     ...
     chreco_ttbar_semi_jerup->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/muon/fixedWP_btag_muon_%s_JERup//uhh2.AnalysisModuleRunner.MC.TTT*.root/AnalysisTree",year.c_str(),year.c_str()));
     TTree *treereco_ttbar_semi_jerup = (TTree*) chreco_ttbar_semi_jerup;

     TChain *chreco_ttbar_semi_jerdown = new TChain("AnalysisTree","");
     chreco_ttbar_semi_jerdown->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/muon/fixedWP_btag_muon_%s_JERdown//uhh2.AnalysisModuleRunner.MC.TTT*.root/AnalysisTree",year.c_str(),year.c_str()));
    ...
    chreco_ttbar_semi_hdampup->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/muon/fixedWP_btag_muon_2017_hdamp/uhh2.AnalysisModuleRunner.MC.TT*up*.root/AnalysisTree",year.c_str()));
    ...
    chreco_ttbar_semi_hdampdown->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/muon/fixedWP_btag_muon_2017_hdamp/uhh2.AnalysisModuleRunner.MC.TT*down*.root/AnalysisTree",year.c_str()));
...
//--------Unfold----------??
    ...
    string  muIDUp = "(weight_sfmu_HighPtID_up)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag)*(muonrecSF_nominal)*1.07";
    string  muIDDown = "(weight_sfmu_HighPtID_down)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag)*(muonrecSF_nominal)*0.93";
    ...
    string  btag_HF_unc17Up = "(weight_sfmu_HighPtID)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag_bc_up_un)*(muonrecSF_nominal)";
    string  btag_LF_unc17Up = "(weight_sfmu_HighPtID)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag_udsg_up_un)*(muonrecSF_nominal)";
    ...
    string  btag_HF_unc17Down = "(weight_sfmu_HighPtID)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag_bc_down_un)*(muonrecSF_nominal)";
    string  btag_LF_unc17Down = "(weight_sfmu_HighPtID)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag_udsg_down_un)*(muonrecSF_nominal)";
    ...
    string  ISRDown = "(weight_sfmu_HighPtID)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag_bc_up)*(muonrecSF_nominal)";
    ...
    string  FSRDown = "(weight_sfmu_HighPtID)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag_bc_up)*(muonrecSF_nominal)";
    ...
    string  hdampUp = "(weight_sfmu_HighPtID)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag)*(muonrecSF_nominal)*1.02";
    string  hdampDown = "(weight_sfmu_HighPtID)*(weight_pu)*(weight_sfmu_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag)*(muonrecSF_nominal)*1.02";
...
//btagging
    ...
    TH1F *Ttbar_1_hdampmu17Up = new TH1F("Ttbar_1_hdampmu17Up","",newrec,new_rec);   Ttbar_1_hdampmu17Up->SetBinContent(1,Migration_Matrix_hdampUp->GetBinContent(1,1)); Ttbar_1_hdampmu17Up->SetBinContent(2,Migration_Matrix_hdampUp->GetBinContent(2,1));
    TH1F *Ttbar_2_hdampmu17Up = new TH1F("Ttbar_2_hdampmu17Up","",newrec,new_rec);   Ttbar_2_hdampmu17Up->SetBinContent(1,Migration_Matrix_hdampUp->GetBinContent(1,2)); Ttbar_2_hdampmu17Up->SetBinContent(2,Migration_Matrix_hdampUp->GetBinContent(2,2));
    ...
    TH1F *Ttbar_1_hdampmu17Down = new TH1F("Ttbar_1_hdampmu17Down","",newrec,new_rec);   Ttbar_1_hdampmu17Down->SetBinContent(1,Migration_Matrix_hdampDown->GetBinContent(1,1)); Ttbar_1_hdampmu17Down->SetBinContent(2,Migration_Matrix_hdampDown->GetBinContent(2,1));
    TH1F *Ttbar_2_hdampmu17Down = new TH1F("Ttbar_2_hdampmu17Down","",newrec,new_rec);   Ttbar_2_hdampmu17Down->SetBinContent(1,Migration_Matrix_hdampDown->GetBinContent(1,2)); Ttbar_2_hdampmu17Down->SetBinContent(2,Migration_Matrix_hdampDown->GetBinContent(2,2));
...
Ttbar_1_jerUp->Write();
Ttbar_2_jerUp->Write();
Ttbar_1_hdampmu17Up->Write();
Ttbar_2_hdampmu17Up->Write();
...
Ttbar_1_hdampmu17Down->Write();
Ttbar_2_hdampmu17Down->Write();
...
latex2.DrawLatex(0.9,2.05,"41.5 fb^{-1} (13 TeV)");
