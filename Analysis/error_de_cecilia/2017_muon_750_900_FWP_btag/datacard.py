...
datacard.write("\n")
datacard.write('others group = btag_HF_corr btag_LF_corr btag_HF_unc18 btag_LF_unc18 toptag muID mistag pileup muHLT Top_pT_rew muon_rec ISR FSR hdampmu17 jer')
