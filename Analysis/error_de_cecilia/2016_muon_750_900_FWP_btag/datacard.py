...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/error_de_cecilia/2016_muon_750_900_FWP_btag/DeltaY.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/error_de_cecilia/2016_muon_750_900_FWP_btag/DeltaY.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")
...
datacard.write("\n")
datacard.write('others group = btag_HF_corr btag_LF_corr btag_HF_unc18 btag_LF_unc18 toptag muID mistag pileup muHLT Top_pT_rew muon_rec ISR FSR hdampmu16 jer')
