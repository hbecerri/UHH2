...
stackList = { "TTToOthers":[kRed+2],"TTToSemiLeptonic_2017v2":[kRed], "Others":[kBlue], "WJetsToLNu_2017v2":[kGreen]}
...
sample_names = ["DYJetsToLL_M-50_HT_2017v2", "QCD_HT_2017v2", "ST_2017v2",  "WJetsToLNu_2017v2","TTToSemiLeptonic_2017v2","TTToOthers"]
...
for sample in sample_names:
		...
		tree_MC[sample]=_file[sample].Get("AnalysisTree")
 	        ...
 	        tree_MC[sample].Draw("%s>>h2_%s(%i,%i,%f)"%(histName,sample,histograms[histName][2],histograms[histName][3][0],histograms[histName][3][1]),"(ttagN <= 1 && wtagN <=1 && btagN >= 1 && Mttbar > 750 && Mttbar < 900 && rec_chi2<30)*weight*(weight_sfelec_TightID)*(weight_pu)*(weight_sfelec_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btagdisc_central)*(weight_sfelec_Rec)*(weight_HT_HT)*0.95")
                ...
                if(sample == "DYJetsToLL_M-50_HT_2017v2" or sample == "QCD_HT_2017v2" or sample == "ST_2017v2"):
                    ...
                    if(sample == "TTToSemiLeptonic_2017v2"):
                        legendR.AddEntry(hist1_[sample],"t#bar{t} (l+jets)",'f')
                    if(sample == "WJetsToLNu_2017v2"):
