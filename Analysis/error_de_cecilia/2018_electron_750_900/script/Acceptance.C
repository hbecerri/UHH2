...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar->Add("/nfs/dust/cms/user/hugobg/ZPrime_102X/presel_output/Acc_2018/Selection/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2018_0.root/AnalysisTree");
    TTree *treereco_ttbar = (TTree*) chreco_ttbar;

    TFile* file = TFile::Open("/nfs/dust/cms/user/hugobg/ZPrime_102X/presel_output/Acc_2018/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2018_1.root");
