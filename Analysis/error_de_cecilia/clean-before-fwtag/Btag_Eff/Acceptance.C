...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    TFile* file = TFile::Open("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2018/muon/Btag_Eff_muon_2018/BtagEff.root");
    ...
    TFile out("BTagMCEfficiencyHists_muon2018.root","recreate");
    ...
    c1->cd();
    BTagMCEffFlavBPassing->Draw("colz TEXT");
    c1->Print("BTagMCEffFlavB_2018muon.pdf");

    auto c2 = new TCanvas("c2","c2",600,400);
    c2->cd();
    BTagMCEffFlavUDSGPassing->Draw("colz TEXT");
    c2->Print("BTagMCEffFlavUDSGP_2018muon.pdf");
