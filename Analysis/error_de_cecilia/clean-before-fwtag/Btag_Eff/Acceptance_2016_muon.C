...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    TFile* file = TFile::Open("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2016/muon/Btag_eff_2016_muon/BtagEff.root");
    ...
    c1->Print("BTagMCEffFlavB_2016muon.pdf");

    auto c2 = new TCanvas("c2","c2",600,400);
    c2->cd();
    c2->SetLogx();
    BTagMCEffFlavUDSGPassing->Draw("colz TEXT1");
    c2->Print("BTagMCEffFlavUDSGP_2016muon.pdf");
