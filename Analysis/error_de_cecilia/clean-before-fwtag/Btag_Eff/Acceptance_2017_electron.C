...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    TFile* file = TFile::Open("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2017/electron/Btag_eff_electron_2017/BtagEff.root");
    ...
    TFile out("BTagMCEfficiencyHists_electron2017.root","recreate");
    ...
    c1->Print("BTagMCEffFlavB_2017electron.pdf");

    auto c2 = new TCanvas("c2","c2",600,400);
    c2->cd();
    c2->SetLogx();
    BTagMCEffFlavUDSGPassing->Draw("colz TEXT1");
    c2->Print("BTagMCEffFlavUDSGP_2017electron.pdf");
