...
//    TH1F *Ttbar_4_hdampUp = new TH1F("Ttbar_4_hdampUp","",newrec,new_rec);   Ttbar_4_hdampUp->SetBinContent(1,Migration_Matrix_hdampUp->GetBinContent(1,2)); Ttbar_4_hdampUp->SetBinContent(2,Migration_Matrix_hdampUp->GetBinContent(2,2));
    TH1F *Ttbar_3_bcUp = new TH1F("Ttbar_3_bcUp","",newrec,new_rec);   Ttbar_3_bcUp->SetBinContent(1,Migration_Matrix_bcUp->GetBinContent(1,1)); Ttbar_3_bcUp->SetBinContent(2,Migration_Matrix_bcUp->GetBinContent(2,1));
    TH1F *Ttbar_4_bcUp = new TH1F("Ttbar_4_bcUp","",newrec,new_rec);   Ttbar_4_bcUp->SetBinContent(1,Migration_Matrix_bcUp->GetBinContent(1,2)); Ttbar_4_bcUp->SetBinContent(2,Migration_Matrix_bcUp->GetBinContent(2,2));
    TH1F *Ttbar_3_btagUp = new TH1F("Ttbar_3_btagUp","",newrec,new_rec);   Ttbar_3_btagUp->SetBinContent(1,Migration_Matrix_btagUp->GetBinContent(1,1)); Ttbar_3_btagUp->SetBinContent(2,Migration_Matrix_btagUp->GetBinContent(2,1));
    TH1F *Ttbar_4_btagUp = new TH1F("Ttbar_4_btagUp","",newrec,new_rec);   Ttbar_4_btagUp->SetBinContent(1,Migration_Matrix_btagUp->GetBinContent(1,2)); Ttbar_4_btagUp->SetBinContent(2,Migration_Matrix_btagUp->GetBinContent(2,2));
    TH1F *Ttbar_3_udsgUp = new TH1F("Ttbar_3_udsgUp","",newrec,new_rec);   Ttbar_3_udsgUp->SetBinContent(1,Migration_Matrix_udsgUp->GetBinContent(1,1)); Ttbar_3_udsgUp->SetBinContent(2,Migration_Matrix_udsgUp->GetBinContent(2,1));
    TH1F *Ttbar_4_udsgUp = new TH1F("Ttbar_4_udsgUp","",newrec,new_rec);   Ttbar_4_udsgUp->SetBinContent(1,Migration_Matrix_udsgUp->GetBinContent(1,2)); Ttbar_4_udsgUp->SetBinContent(2,Migration_Matrix_udsgUp->GetBinContent(2,2));
...
//    TH1F *Ttbar_4_jesDown = new TH1F("Ttbar_4_jesDown","",newrec,new_rec);   Ttbar_4_jesDown->SetBinContent(1,Migration_Matrix_jesDown->GetBinContent(1,2)); Ttbar_4_jesDown->SetBinContent(2,Migration_Matrix_jesDown->GetBinContent(2,2));
    TH1F *Ttbar_3_bcDown = new TH1F("Ttbar_3_bcDown","",newrec,new_rec);   Ttbar_3_bcDown->SetBinContent(1,Migration_Matrix_bcDown->GetBinContent(1,1)); Ttbar_3_bcDown->SetBinContent(2,Migration_Matrix_bcDown->GetBinContent(2,1));
    TH1F *Ttbar_4_bcDown = new TH1F("Ttbar_4_bcDown","",newrec,new_rec);   Ttbar_4_bcDown->SetBinContent(1,Migration_Matrix_bcDown->GetBinContent(1,2)); Ttbar_4_bcDown->SetBinContent(2,Migration_Matrix_bcDown->GetBinContent(2,2));
    TH1F *Ttbar_3_btagDown = new TH1F("Ttbar_3_btagDown","",newrec,new_rec);   Ttbar_3_btagDown->SetBinContent(1,Migration_Matrix_btagDown->GetBinContent(1,1)); Ttbar_3_btagDown->SetBinContent(2,Migration_Matrix_btagDown->GetBinContent(2,1));
    TH1F *Ttbar_4_btagDown = new TH1F("Ttbar_4_btagDown","",newrec,new_rec);   Ttbar_4_btagDown->SetBinContent(1,Migration_Matrix_btagDown->GetBinContent(1,2)); Ttbar_4_btagDown->SetBinContent(2,Migration_Matrix_btagDown->GetBinContent(2,2));
    TH1F *Ttbar_3_udsgDown = new TH1F("Ttbar_3_udsgDown","",newrec,new_rec);   Ttbar_3_udsgDown->SetBinContent(1,Migration_Matrix_udsgDown->GetBinContent(1,1)); Ttbar_3_udsgDown->SetBinContent(2,Migration_Matrix_udsgDown->GetBinContent(2,1));
    TH1F *Ttbar_4_udsgDown = new TH1F("Ttbar_4_udsgDown","",newrec,new_rec);   Ttbar_4_udsgDown->SetBinContent(1,Migration_Matrix_udsgDown->GetBinContent(1,2)); Ttbar_4_udsgDown->SetBinContent(2,Migration_Matrix_udsgDown->GetBinContent(2,2));
...
Ttbar_3_bcUp->Write();
Ttbar_4_bcUp->Write();
Ttbar_3_btagUp->Write();
Ttbar_4_btagUp->Write();
Ttbar_3_udsgUp->Write();
Ttbar_4_udsgUp->Write();
...
Ttbar_3_bcDown->Write();
Ttbar_4_bcDown->Write();
Ttbar_3_btagDown->Write();
Ttbar_4_btagDown->Write();
Ttbar_3_udsgDown->Write();
Ttbar_4_udsgDown->Write();
