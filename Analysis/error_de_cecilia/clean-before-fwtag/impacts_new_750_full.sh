...
export SetParametersExplicit="r_nMlo=1,r_pMlo=1,r_nMhi=1,Ac=0.0070"
export SetParameterRanges="r_nMlo=0.5,2:r_pMlo=0.5,2:r_nMhi=-3.05,100.5:Ac=-2,2"
export redefineSignalPOIs="r_nMlo,r_pMlo,r_nMhi,Ac"
