...
//    TH2F *Migration_Matrix_jerDown = new TH2F("Migration_Matrix_jerDown","",newrec,new_rec,binnum_gen,bins_gen);
    ...
    string  Top_pT_rewUp = "(weight_sfelec_TightID)*(weight_pu)*(weight_sfelec_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btagdisc_central)*(weight_sfelec_Rec)*(weight_HT_HT)";
...
//btagging
    ...
    TH1F *Ttbar_3_eleIDUp = new TH1F("Ttbar_3_eleIDUp","",newrec,new_rec);      Ttbar_3_eleIDUp->SetBinContent(1,Migration_Matrix_eleIDUp->GetBinContent(1,1)); Ttbar_3_eleIDUp->SetBinContent(2,Migration_Matrix_eleIDUp->GetBinContent(2,1));
    TH1F *Ttbar_4_eleIDUp = new TH1F("Ttbar_4_eleIDUp","",newrec,new_rec);      Ttbar_4_eleIDUp->SetBinContent(1,Migration_Matrix_eleIDUp->GetBinContent(1,2)); Ttbar_4_eleIDUp->SetBinContent(2,Migration_Matrix_eleIDUp->GetBinContent(2,2));
    TH1F *Ttbar_3_eleHLTUp = new TH1F("Ttbar_3_eleHLTUp","",newrec,new_rec);    Ttbar_3_eleHLTUp->SetBinContent(1,Migration_Matrix_eleHLTUp->GetBinContent(1,1)); Ttbar_3_eleHLTUp->SetBinContent(2,Migration_Matrix_eleHLTUp->GetBinContent(2,1));
    TH1F *Ttbar_4_eleHLTUp = new TH1F("Ttbar_4_eleHLTUp","",newrec,new_rec);    Ttbar_4_eleHLTUp->SetBinContent(1,Migration_Matrix_eleHLTUp->GetBinContent(1,2)); Ttbar_4_eleHLTUp->SetBinContent(2,Migration_Matrix_eleHLTUp->GetBinContent(2,2));
    ...
    TH1F *Ttbar_3_ele_recUp = new TH1F("Ttbar_3_ele_recUp","",newrec,new_rec);    Ttbar_3_ele_recUp->SetBinContent(1,Migration_Matrix_ele_recUp->GetBinContent(1,1)); Ttbar_3_ele_recUp->SetBinContent(2,Migration_Matrix_ele_recUp->GetBinContent(2,1));
    TH1F *Ttbar_4_ele_recUp = new TH1F("Ttbar_4_ele_recUp","",newrec,new_rec);    Ttbar_4_ele_recUp->SetBinContent(1,Migration_Matrix_ele_recUp->GetBinContent(1,2)); Ttbar_4_ele_recUp->SetBinContent(2,Migration_Matrix_ele_recUp->GetBinContent(2,2));
...
//    TH1F *Ttbar_4_jerUp = new TH1F("Ttbar_4_jerUp","",newrec,new_rec);   Ttbar_4_jerUp->SetBinContent(1,Migration_Matrix_jerUp->GetBinContent(1,2)); Ttbar_4_jerUp->SetBinContent(2,Migration_Matrix_jerUp->GetBinContent(2,2));
    ...
    TH1F *Ttbar_3_eleIDDown = new TH1F("Ttbar_3_eleIDDown","",newrec,new_rec);      Ttbar_3_eleIDDown->SetBinContent(1,Migration_Matrix_eleIDDown->GetBinContent(1,1)); Ttbar_3_eleIDDown->SetBinContent(2,Migration_Matrix_eleIDDown->GetBinContent(2,1));
    TH1F *Ttbar_4_eleIDDown = new TH1F("Ttbar_4_eleIDDown","",newrec,new_rec);      Ttbar_4_eleIDDown->SetBinContent(1,Migration_Matrix_eleIDDown->GetBinContent(1,2)); Ttbar_4_eleIDDown->SetBinContent(2,Migration_Matrix_eleIDDown->GetBinContent(2,2));
    TH1F *Ttbar_3_eleHLTDown = new TH1F("Ttbar_3_eleHLTDown","",newrec,new_rec);    Ttbar_3_eleHLTDown->SetBinContent(1,Migration_Matrix_eleHLTDown->GetBinContent(1,1)); Ttbar_3_eleHLTDown->SetBinContent(2,Migration_Matrix_eleHLTDown->GetBinContent(2,1));
    TH1F *Ttbar_4_eleHLTDown = new TH1F("Ttbar_4_eleHLTDown","",newrec,new_rec);    Ttbar_4_eleHLTDown->SetBinContent(1,Migration_Matrix_eleHLTDown->GetBinContent(1,2)); Ttbar_4_eleHLTDown->SetBinContent(2,Migration_Matrix_eleHLTDown->GetBinContent(2,2));
    ...
    TH1F *Ttbar_3_ele_recDown = new TH1F("Ttbar_3_ele_recDown","",newrec,new_rec);    Ttbar_3_ele_recDown->SetBinContent(1,Migration_Matrix_ele_recDown->GetBinContent(1,1)); Ttbar_3_ele_recDown->SetBinContent(2,Migration_Matrix_ele_recDown->GetBinContent(2,1));
    TH1F *Ttbar_4_ele_recDown = new TH1F("Ttbar_4_ele_recDown","",newrec,new_rec);    Ttbar_4_ele_recDown->SetBinContent(1,Migration_Matrix_ele_recDown->GetBinContent(1,2)); Ttbar_4_ele_recDown->SetBinContent(2,Migration_Matrix_ele_recDown->GetBinContent(2,2));
...
Ttbar_3_eleIDUp->Write();
Ttbar_4_eleIDUp->Write();
Ttbar_3_eleHLTUp->Write();
Ttbar_4_eleHLTUp->Write();
...
Ttbar_3_ele_recUp->Write();
Ttbar_4_ele_recUp->Write();
Ttbar_3_ISRUp->Write();
Ttbar_4_ISRUp->Write();
Ttbar_3_FSRUp->Write();
Ttbar_4_FSRUp->Write();
...
Ttbar_3_eleIDDown->Write();
Ttbar_4_eleIDDown->Write();
Ttbar_3_eleHLTDown->Write();
Ttbar_4_eleHLTDown->Write();
...
Ttbar_3_ele_recDown->Write();
Ttbar_4_ele_recDown->Write();
