...
systematic_direction={'PDF_1','PDF_2','PDF_3','PDF_4','PDF_5','PDF_6','PDF_7','PDF_8','PDF_9'}
samplelist = {'Ttbar_1','Ttbar_2', 'singletop', 'ttbar_others', 'wjets'}
...
#        systvarhistRatio[samp+syst+'__minus__ratio'].Draw('same')
        ...
        canvas_Bkg[samp+syst].SaveAs(samp+syst+'.pdf')
