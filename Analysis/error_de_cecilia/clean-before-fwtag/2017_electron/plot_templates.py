...
#                systvarhistDraw[samp+syst+'Down'].SetMarkerStyle(21)
                ...
                nominalhistDraw[samp+syst].GetYaxis().SetRangeUser(0,4000)
                systvarhistDraw[samp+syst+'Up'].GetYaxis().SetRangeUser(0,4000)
                systvarhistDraw[samp+syst+'Down'].GetYaxis().SetRangeUser(0,4000)
