...
text2workspace.py Ac_900.txt -o Ac_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_1:r_nMlo[1,0,20]' --PO map='.*/Ttbar_3:r_nMhi[1,0,20]' --PO map='.*/Ttbar_4:r_pMhi[1,0,20]' --PO map='.*/Ttbar_2:r_pMlo=expr;;r_pMlo("-@0*55198020/92196770 +  89899404/92196770*@2*(1+@1)/(1-@1) +  55204415/92196770*@3*(1+@1)/(1-@1)",r_pMhi,Ac[0.0077,-2,2],r_nMlo,r_nMhi)'  --PO verbose

bash impacts_new_all_full.sh

mv r_nMlo.pdf r_nMlo_all_full.pdf
mv Ac.pdf Ac_all_full.pdf
mv r_nMhi.pdf rnMhi_all_full.pdf
mv r_pMhi.pdf r_pMhi_all_full.pdf
