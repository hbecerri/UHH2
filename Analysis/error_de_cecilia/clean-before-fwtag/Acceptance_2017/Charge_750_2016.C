...
void Charge_750_2016(string var_weight = "1", int aa = 1)
{
...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar_antes_muon->Add("/pnfs/desy.de/cms/tier2/store/group/uhh/uhh2ntuples/RunII_102X_v2/2016v3/TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8/crab_TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_Summer16_v1/210611_220354/0000/*.root/AnalysisTree");
    chreco_ttbar_antes_muon->Add("/pnfs/desy.de/cms/tier2/store/user/pgunnell/RunII_102X_v1/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/crab_TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/190505_200110/0001/*.root/AnalysisTree");
...
//array for variable 
    ...
    TH1F *Acc_antes_muon_nominal_750_900 = new TH1F("Acc_antes_muon_nominal_750_900","",binnum_gen,bins_gen);
    ...
    treereco_ttbar_antes_muon->Project("Acc_antes_muon_nominal_750",Form("%s",var_gen.c_str()),Form("(%s >750)",Mttbar_gen.c_str()));
    treereco_ttbar_antes_muon->Project("Acc_antes_muon_nominal_750_900",Form("%s",var_gen.c_str()),Form("(%s >750 && %s < 900)",Mttbar_gen.c_str(),Mttbar_gen.c_str()));
    treereco_ttbar_antes_muon->Project("Acc_antes_muon_nominal_900",Form("%s",var_gen.c_str()),Form("(%s >900)",Mttbar_gen.c_str()));

    cout << (Acc_antes_muon_nominal_750->GetBinContent(2) - Acc_antes_muon_nominal_750->GetBinContent(1))/(Acc_antes_muon_nominal_750->GetBinContent(2) + Acc_antes_muon_nominal_750->GetBinContent(1)) << endl;
    cout << (Acc_antes_muon_nominal_750_900->GetBinContent(2) - Acc_antes_muon_nominal_750_900->GetBinContent(1))/(Acc_antes_muon_nominal_750_900->GetBinContent(2) + Acc_antes_muon_nominal_750_900->GetBinContent(1)) << endl;
    cout << (Acc_antes_muon_nominal_900->GetBinContent(2) - Acc_antes_muon_nominal_900->GetBinContent(1))/(Acc_antes_muon_nominal_900->GetBinContent(2) + Acc_antes_muon_nominal_900->GetBinContent(1));  
