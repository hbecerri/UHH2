...
void Charge_750_900_2016(string var_weight = "1", int aa = 1)
{
...
//array for variable 
    ...
    treereco_ttbar_antes_muon->Project("Acc_antes_muon_nominal",Form("%s",var_gen.c_str()),Form("(%s >750 && %s < 900)",Mttbar_gen.c_str(),Mttbar_gen.c_str()));
