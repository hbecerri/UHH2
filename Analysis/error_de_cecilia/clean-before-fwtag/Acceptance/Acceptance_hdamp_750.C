...
void Acceptance_hdamp_750(string var_weight = "1", int aa = 1)
{
...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    chreco_ttbar_antes_muon->Add("/nfs/dust/cms/group/zprime-uhh/Presel_2016/Preselection_Acceptance/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2016v3_23.root/AnalysisTree");
    TTree *treereco_ttbar_antes_muon = (TTree*) chreco_ttbar_antes_muon;

    TChain *chreco_ttbar_despues_muon = new TChain("AnalysisTree","");
    chreco_ttbar_despues_muon->Add("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2016_CHS/muon/workdir_Zprime_Analysis_2016_muon_CHS_Acceptance/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2016v3_1.root/AnalysisTree");
    ...
    chreco_ttbar_despues_electron->Add("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2016_CHS/electron/workdir_Zprime_Analysis_2016_electron_CHS_Acceptance/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_2016v3_1.root/AnalysisTree");
