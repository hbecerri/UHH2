...
text2workspace.py Ac_2016_750_900.txt -o Ac_2016_750_900.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_1:r_nMlo[1,0,20]' --PO map='.*/Ttbar_3:r_nMhi[1,0,20]' --PO map='.*/Ttbar_2:r_pMlo[1,0,20]' --PO map='.*/Ttbar_4:r_pMhi=expr;;r_pMhi("-@0*63596544/11755304 +  62073452/11755304*@2*(1+@1)/(1-@1) +  12227111/11755304*@3*(1+@1)/(1-@1)",r_pMlo,Ac[0.007,-2,2],r_nMlo,r_nMhi)'  --PO verbose


bash impacts_new_750_full.sh
mv r_nMlo.pdf r_nMlo_750_full.pdf
mv r_nMhi.pdf r_nMhi_750_full.pdf
mv r_pMlo.pdf r_pMlo_750_full.pdf
mv r_pMhi.pdf r_pMhi_750_full.pdf
