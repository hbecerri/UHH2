...
N_reco_bins = 0
datacard=open("ele_2017_750_900.txt","w")
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/error_de_cecilia/2017_electron_750_900_FWP_btag/DeltaY.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/error_de_cecilia/2017_electron_750_900_FWP_btag/DeltaY.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")

datacard.write("----------------\n")

datacard.write("bin electron_2017_750_900")
datacard.write("\n")
...
for ireco in range(1,7):
    datacard.write("electron_2017_750_900 ")
datacard.write("\n")
...
for name in syst:
    ...
    datacard.write("\n")
datacard.write('* autoMCStats 1000 1 1')
datacard.write("\n")
...
datacard.write("\n")
datacard.write('others group = btag_HF_corr btag_LF_corr btag_HF_unc18 btag_LF_unc18 toptag eleID mistag pileup eleHLT Top_pT_rew ele_rec ISR FSR hdampele17 jer')
