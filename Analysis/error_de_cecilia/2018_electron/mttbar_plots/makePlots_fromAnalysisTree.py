...
stackList = { "TTToOthers":[kRed+2],"TTToSemiLeptonic_2018":[kRed], "DYJetsToLL_M-50_HT_2018":[kBlue], "QCD_HT_2018":[kTeal], "WJetsToLNu_2018":[kGreen], "ST_2018":[kYellow], "WW_WZ_ZZ_2018":[kOrange]}
...
if log:
	...
	canvasRatio.SaveAs("%s_900.pdf"%(histName))
