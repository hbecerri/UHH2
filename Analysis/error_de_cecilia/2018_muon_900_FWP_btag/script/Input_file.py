...
categories=['T1']
fout = TFile('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/error_de_cecilia/2018_muon_900_FWP_btag/'+argv[1]+'_muon_3cat.root', 'recreate')
...
for cat in categories:
    if cat == 'T1':
            ...
            for key_sample in samplelist:
                ...
                gDirectory.cd('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/error_de_cecilia/2018_muon_900_FWP_btag/'+argv[1]+'_muon_3cat.root:/')
                if key_sample == 'DATA':
                    gDirectory.cd('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/error_de_cecilia/2018_muon_900_FWP_btag/'+argv[1]+'_muon_3cat.root:/')
