...
//----obetener_toda_la_informacion_de_entrada--------??
    ...
    //jer
     ...
     chreco_ttbar_semi_jerup->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/electron/fixedWP_btag_electron_%s_JERup/uhh2.AnalysisModuleRunner.MC.TTToS*.root/AnalysisTree",year.c_str(),year.c_str()));
     TTree *treereco_ttbar_semi_jerup = (TTree*) chreco_ttbar_semi_jerup;

     TChain *chreco_ttbar_semi_jerdown = new TChain("AnalysisTree","");
     chreco_ttbar_semi_jerdown->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/electron/fixedWP_btag_electron_%s_JERdown/uhh2.AnalysisModuleRunner.MC.TTToS*.root/AnalysisTree",year.c_str(),year.c_str()));
    ...
    chreco_ttbar_semi_hdampup->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/electron/fixedWP_btag_electron_2018_hdamp/uhh2.AnalysisModuleRunner.MC.*up*.root/AnalysisTree",year.c_str()));
    ...
    chreco_ttbar_semi_hdampdown->Add(Form("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/%s_CHS/electron/fixedWP_btag_electron_2018_hdamp/uhh2.AnalysisModuleRunner.MC.*down*.root/AnalysisTree",year.c_str()));
...
//--------Unfold----------??
    ...
    string  btag_HF_unc18Up = "(weight_sfelec_TightID)*(weight_pu)*(weight_sfelec_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag_bc_up_un)*(weight_sfelec_Rec)";
    string  btag_LF_unc18Up = "(weight_sfelec_TightID)*(weight_pu)*(weight_sfelec_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag_udsg_up_un)*(weight_sfelec_Rec)";
    ...
    string  btag_HF_unc18Down = "(weight_sfelec_TightID)*(weight_pu)*(weight_sfelec_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag_bc_down_un)*(weight_sfelec_Rec)";
    string  btag_LF_unc18Down = "(weight_sfelec_TightID)*(weight_pu)*(weight_sfelec_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag_udsg_down_un)*(weight_sfelec_Rec)";
    ...
    string  hdampUp = "(weight_sfelec_TightID)*(weight_pu)*(weight_sfelec_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag)*(weight_sfelec_Rec)*1.13";
    string  hdampDown = "(weight_sfelec_TightID)*(weight_pu)*(weight_sfelec_Trigger)*(weight_toptagSF_)*(weight_pt_rew_nolimit)*(weight_btag)*(weight_sfelec_Rec)*1.08";
...
//btagging
    ...
    TH1F *Ttbar_1_hdampele18Up = new TH1F("Ttbar_1_hdampele18Up","",newrec,new_rec);   Ttbar_1_hdampele18Up->SetBinContent(1,Migration_Matrix_hdampUp->GetBinContent(1,1)); Ttbar_1_hdampele18Up->SetBinContent(2,Migration_Matrix_hdampUp->GetBinContent(2,1));
    TH1F *Ttbar_2_hdampele18Up = new TH1F("Ttbar_2_hdampele18Up","",newrec,new_rec);   Ttbar_2_hdampele18Up->SetBinContent(1,Migration_Matrix_hdampUp->GetBinContent(1,2)); Ttbar_2_hdampele18Up->SetBinContent(2,Migration_Matrix_hdampUp->GetBinContent(2,2));
    ...
    TH1F *Ttbar_1_hdampele18Down = new TH1F("Ttbar_1_hdampele18Down","",newrec,new_rec);   Ttbar_1_hdampele18Down->SetBinContent(1,Migration_Matrix_hdampDown->GetBinContent(1,1)); Ttbar_1_hdampele18Down->SetBinContent(2,Migration_Matrix_hdampDown->GetBinContent(2,1));
    TH1F *Ttbar_2_hdampele18Down = new TH1F("Ttbar_2_hdampele18Down","",newrec,new_rec);   Ttbar_2_hdampele18Down->SetBinContent(1,Migration_Matrix_hdampDown->GetBinContent(1,2)); Ttbar_2_hdampele18Down->SetBinContent(2,Migration_Matrix_hdampDown->GetBinContent(2,2));
...
Ttbar_1_jerUp->Write();
Ttbar_2_jerUp->Write();
Ttbar_1_hdampele18Up->Write();
Ttbar_2_hdampele18Up->Write();
...
Ttbar_1_hdampele18Down->Write();
Ttbar_2_hdampele18Down->Write();
