...
text2workspace.py muon_2016.txt -o muon_2016.root  -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel -m 125 --PO map='.*/Ttbar_1:r_neg[1,0,20]' --PO map='.*/Ttbar_2:r_pos=expr;;r_pos("(1.008)*7053.01/7156.152*@0*(100+@1)/(100-@1)",r_neg,r_Asym[-2,-5,0])' --PO verbose
