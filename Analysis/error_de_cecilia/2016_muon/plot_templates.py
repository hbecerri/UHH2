...
#systematic_direction={'hfstats1','toptag','muID','miswtag','lfstats2','hf','pileup','muHLT','lf','pt_rew','hfstats2','lfstats1','cferr1','cferr2','jes','HT','muon_rec','pdf','q2','jer','jec', 'ISR', 'FSR', 'hdamp'}
systematic_direction={'jecTimePtEta'}
...
for samp in samplelist:
    for syst in systematic_direction:
        print syst
        if((syst == 'FSR' or syst == 'ISR' or syst == 'jec' or syst == 'jer' or syst == 'q2' or syst == 'pdf') and (samp != 'ttbar_semi')):
            continue 
...
#            continue        
        ...
        latex2.DrawLatex(1.1,a*1.06,"36.77 fb^{-1} (13 TeV)")
