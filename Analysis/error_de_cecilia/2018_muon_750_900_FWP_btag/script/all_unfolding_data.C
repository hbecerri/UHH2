...
//btagging
    ...
    Ttbar_1_pileupUp->SetBinError(1,Migration_Matrix_pileupUp->GetBinError(1,1)); Ttbar_1_pileupUp->SetBinError(2,Migration_Matrix_pileupUp->GetBinError(2,1));
    Ttbar_2_pileupUp->SetBinError(1,Migration_Matrix_pileupUp->GetBinError(1,2)); Ttbar_2_pileupUp->SetBinError(2,Migration_Matrix_pileupUp->GetBinError(2,2));
    Ttbar_1_muIDUp->SetBinError(1,Migration_Matrix_muIDUp->GetBinError(1,1)); Ttbar_1_muIDUp->SetBinError(2,Migration_Matrix_muIDUp->GetBinError(2,1));
    Ttbar_2_muIDUp->SetBinError(1,Migration_Matrix_muIDUp->GetBinError(1,2)); Ttbar_2_muIDUp->SetBinError(2,Migration_Matrix_muIDUp->GetBinError(2,2));
    Ttbar_1_muHLTUp->SetBinError(1,Migration_Matrix_muHLTUp->GetBinError(1,1)); Ttbar_1_muHLTUp->SetBinError(2,Migration_Matrix_muHLTUp->GetBinError(2,1));
    Ttbar_2_muHLTUp->SetBinError(1,Migration_Matrix_muHLTUp->GetBinError(1,2)); Ttbar_2_muHLTUp->SetBinError(2,Migration_Matrix_muHLTUp->GetBinError(2,2));
    Ttbar_1_mistagUp->SetBinError(1,Migration_Matrix_mistagUp->GetBinError(1,1)); Ttbar_1_mistagUp->SetBinError(2,Migration_Matrix_mistagUp->GetBinError(2,1));
    Ttbar_2_mistagUp->SetBinError(1,Migration_Matrix_mistagUp->GetBinError(1,2)); Ttbar_2_mistagUp->SetBinError(2,Migration_Matrix_mistagUp->GetBinError(2,2));
    Ttbar_1_toptagUp->SetBinError(1,Migration_Matrix_toptagUp->GetBinError(1,1)); Ttbar_1_toptagUp->SetBinError(2,Migration_Matrix_toptagUp->GetBinError(2,1));
    Ttbar_2_toptagUp->SetBinError(1,Migration_Matrix_toptagUp->GetBinError(1,2)); Ttbar_2_toptagUp->SetBinError(2,Migration_Matrix_toptagUp->GetBinError(2,2));
    Ttbar_1_muon_recUp->SetBinError(1,Migration_Matrix_muon_recUp->GetBinError(1,1)); Ttbar_1_muon_recUp->SetBinError(2,Migration_Matrix_muon_recUp->GetBinError(2,1));
    Ttbar_2_muon_recUp->SetBinError(1,Migration_Matrix_muon_recUp->GetBinError(1,2)); Ttbar_2_muon_recUp->SetBinError(2,Migration_Matrix_muon_recUp->GetBinError(2,2));
    Ttbar_1_ISRUp->SetBinError(1,Migration_Matrix_ISRUp->GetBinError(1,1)); Ttbar_1_ISRUp->SetBinError(2,Migration_Matrix_ISRUp->GetBinError(2,1));
    Ttbar_2_ISRUp->SetBinError(1,Migration_Matrix_ISRUp->GetBinError(1,2)); Ttbar_2_ISRUp->SetBinError(2,Migration_Matrix_ISRUp->GetBinError(2,2));
    Ttbar_1_FSRUp->SetBinError(1,Migration_Matrix_FSRUp->GetBinError(1,1)); Ttbar_1_FSRUp->SetBinError(2,Migration_Matrix_FSRUp->GetBinError(2,1));
    Ttbar_2_FSRUp->SetBinError(1,Migration_Matrix_FSRUp->GetBinError(1,2)); Ttbar_2_FSRUp->SetBinError(2,Migration_Matrix_FSRUp->GetBinError(2,2));
    ...
    TH1F *Ttbar_1_hdampmu18Up = new TH1F("Ttbar_1_hdampmu18Up","",newrec,new_rec);   Ttbar_1_hdampmu18Up->SetBinContent(1,Migration_Matrix_hdampUp->GetBinContent(1,1)); Ttbar_1_hdampmu18Up->SetBinContent(2,Migration_Matrix_hdampUp->GetBinContent(2,1));
    TH1F *Ttbar_2_hdampmu18Up = new TH1F("Ttbar_2_hdampmu18Up","",newrec,new_rec);   Ttbar_2_hdampmu18Up->SetBinContent(1,Migration_Matrix_hdampUp->GetBinContent(1,2)); Ttbar_2_hdampmu18Up->SetBinContent(2,Migration_Matrix_hdampUp->GetBinContent(2,2));

    Ttbar_1_hdampmu18Up->SetBinError(1,Migration_Matrix_hdampUp->GetBinError(1,1)); Ttbar_1_hdampmu18Up->SetBinError(2,Migration_Matrix_hdampUp->GetBinError(2,1));
    Ttbar_2_hdampmu18Up->SetBinError(1,Migration_Matrix_hdampUp->GetBinError(1,2)); Ttbar_2_hdampmu18Up->SetBinError(2,Migration_Matrix_hdampUp->GetBinError(2,2));
    ...
    TH1F *Ttbar_1_hdampmu18Down = new TH1F("Ttbar_1_hdampmu18Down","",newrec,new_rec);   Ttbar_1_hdampmu18Down->SetBinContent(1,Migration_Matrix_hdampDown->GetBinContent(1,1)); Ttbar_1_hdampmu18Down->SetBinContent(2,Migration_Matrix_hdampDown->GetBinContent(2,1));
    TH1F *Ttbar_2_hdampmu18Down = new TH1F("Ttbar_2_hdampmu18Down","",newrec,new_rec);   Ttbar_2_hdampmu18Down->SetBinContent(1,Migration_Matrix_hdampDown->GetBinContent(1,2)); Ttbar_2_hdampmu18Down->SetBinContent(2,Migration_Matrix_hdampDown->GetBinContent(2,2));

    Ttbar_1_hdampmu18Down->SetBinError(1,Migration_Matrix_hdampDown->GetBinError(1,1)); Ttbar_1_hdampmu18Down->SetBinError(2,Migration_Matrix_hdampDown->GetBinError(2,1));
    Ttbar_2_hdampmu18Down->SetBinError(1,Migration_Matrix_hdampDown->GetBinError(1,2)); Ttbar_2_hdampmu18Down->SetBinError(2,Migration_Matrix_hdampDown->GetBinError(2,2));
...
Ttbar_1_jerUp->Write();
Ttbar_2_jerUp->Write();
Ttbar_1_hdampmu18Up->Write();
Ttbar_2_hdampmu18Up->Write();
...
Ttbar_1_hdampmu18Down->Write();
Ttbar_2_hdampmu18Down->Write();
