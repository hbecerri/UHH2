...
void charge_assy_copy(){
   ...
   double x[] = {0, 1, 2, 3, 4};
   double y[] = {0., 0.0, 0.0, 0.0, 0.0119};
   double ey[] = {0.002, 0.002, 0.002, 0.002, 0.002};
   double ex[] = {0, 0.0, 0, 0.0, 0};
   auto ge = new TGraphErrors(5, x, y, ex, ey);

   double xx[] = {0, 1, 2, 3, 4};
   double yy[] = {0.0119, 0., 0., 0.0, 0.0};
   double eyy[] = {0.002, 0.002, 0.002, 0.002, 0.002};
   double exx[] = {1, 0.5, 1, 0.5, 1};
   auto g2 = new TGraphErrors(5, xx, yy, exx, eyy);
