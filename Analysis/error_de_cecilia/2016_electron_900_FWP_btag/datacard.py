...
N_reco_bins = 0
datacard=open("ele_2016_900.txt","w")
...
datacard.write("shapes data_obs  *  /nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/error_de_cecilia/2016_electron_900_FWP_btag/DeltaY.root $PROCESS\n")
datacard.write("shapes *         *  /nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/error_de_cecilia/2016_electron_900_FWP_btag/DeltaY.root $PROCESS_nominal $PROCESS_$SYSTEMATIC\n")

datacard.write("----------------\n")

datacard.write("bin electron_2016_900")
datacard.write("\n")
...
for ireco in range(1,7):
    datacard.write("electron_2016_900 ")
datacard.write("\n")
