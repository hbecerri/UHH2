...
def back_yields(Rootfile):
    ...
    return Ttbar_1_nominal, Ttbar_1_error, Ttbar_2_nominal, Ttbar_2_error, wjets_nominal, wjets_error, dy_nominal, dy_error, qcd_nominal, qcd_error, ST_nominal, ST_error, data
...
channel_1 = TFile("2016_muon_750_900_FWP_btag/DeltaY.root")
channel_2 = TFile("2016_electron_750_900_FWP_btag/DeltaY.root")
channel_3 = TFile("2017_muon_750_900_FWP_btag/DeltaY.root")
channel_4 = TFile("2017_electron_750_900_FWP_btag/DeltaY.root")
channel_5 = TFile("2018_muon_750_900_FWP_btag/DeltaY.root")
channel_6 = TFile("2018_electron_750_900_FWP_btag/DeltaY.root")

a11, a12, b11, b12, c11, c12, d11, d12, f11, f12, g11, g12, data1 = back_yields(channel_1) 
a21, a22, b21, b22, c21, c22, d21, d22, f21, f22, g21, g22, data2 = back_yields(channel_2)
a31, a32, b31, b32, c31, c32, d31, d32, f31, f32, g31, g32, data3 = back_yields(channel_3)
a41, a42, b41, b42, c41, c42, d41, d42, f41, f42, g41, g42, data4 = back_yields(channel_4)
a51, a52, b51, b52, c51, c52, d51, d52, f51, f52, g51, g52, data5 = back_yields(channel_5)
a61, a62, b61, b62, c61, c62, d61, d62, f61, f62, g61, g62, data6 = back_yields(channel_6)

total_nominal_muon_2016 = int(a11 + b11 + c11 + d11 + f11 + g11)
total_error_muon_2016 = int(math.sqrt(a12*a12 + b12*b12 + c12*c12 + d12*d12 + f12*f12 + g12*g12))
total_nominal_muon_2017 = int(a31 + b31 + c31 + d31 + f31 + g31)
total_error_muon_2017 = int(math.sqrt(a32*a32 + b32*b32 + c32*c32 + d32*d32 + f32*f32 + g32*g32))
total_nominal_muon_2018 = int(a51 + b51 + c51 + d51 + f51 + g51)
total_error_muon_2018 = int(math.sqrt(a52*a52 + b52*b52 + c52*c52 + d52*d52 + f52*f52 + g52*g52))

total_nominal_electron_2016 = int(a21 + b21 + c21 + d21 + f21 + g21)
total_error_electron_2016 = int(math.sqrt(a22*a22 + b22*b22 + c22*c22 + d22*d22 + f22*f22 + g22*g22))
total_nominal_electron_2017 = int(a41 + b41 + c41 + d41 + f41 + g41)
total_error_electron_2017 = int(math.sqrt(a42*a42 + b42*b42 + c42*c42 + d42*d42 + f42*f42 + g42*g42))
total_nominal_electron_2018 = int(a61 + b61 + c61 + d61 + f61 + g61)
total_error_electron_2018 = int(math.sqrt(a62*a62 + b62*b62 + c62*c62 + d62*d62 + f62*f62 + g62*g62))
