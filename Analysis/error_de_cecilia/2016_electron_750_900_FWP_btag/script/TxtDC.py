...
for x in range(len(channels)):
	...
	list_files["file_{0}".format(x)].write("shapes * * "+argv[1]+".root $CHANNEL/$PROCESS/nominal $CHANNEL/$PROCESS/$SYSTEMATIC\n")
	list_files["file_{0}".format(x)].write("---------------------------------------------------\n")
	...
	list_files["file_{0}".format(x)].write("ttbar_rate param 1.0 0.05\n")
        list_files["file_{0}".format(x)].write("ttbar_rate rateParam * ttbar_others 1\n")
        list_files["file_{0}".format(x)].write("ttbar_rate param 1.0 0.05\n")
        list_files["file_{0}".format(x)].write("wjets_rate rateParam * wjets 1\n")
        list_files["file_{0}".format(x)].write("wjets_rate param 1.0 0.30\n")
        list_files["file_{0}".format(x)].write("wjets_rate rateParam * singletop 1\n")
        list_files["file_{0}".format(x)].write("wjets_rate param 1.0 0.30\n")	
        list_files["file_{0}".format(x)].write("wjets_rate rateParam * dy 1\n")
        list_files["file_{0}".format(x)].write("wjets_rate param 1.0 0.30\n")
        list_files["file_{0}".format(x)].write("wjets_rate rateParam * qcd 1\n")
        list_files["file_{0}".format(x)].write("wjets_rate param 1.0 0.30\n")
        list_files["file_{0}".format(x)].write("wjets_rate rateParam * vv 1\n")
        list_files["file_{0}".format(x)].write("wjets_rate param 1.0 0.30\n")
