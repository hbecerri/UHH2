...
//   mg->Add(ge,"a3");
   ...
   latex.DrawLatex(0.02,0.202,"Work in progress");

   TLatex latex2;
   latex2.SetTextSize(0.045);
   latex2.SetTextAlign(11);  //align at top
   latex2.DrawLatex(2.9,0.202,"36.73 fb^{-1} (13 TeV)");

   c1->Print("Ac_electron_2017.pdf");
