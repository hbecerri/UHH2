...
void nJets(string var_name = "", string var_gen = "", string region = "", string year = "2018")
{
    ...
    chreco_ttbar->Add("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2018_CHS/muon/uhh2.AnalysisModuleRunner.MC.*.root/AnalysisTree");
    TTree *treereco_ttbar = (TTree*) chreco_ttbar;

    TChain *chreco_data = new TChain("AnalysisTree","");
    chreco_data->Add("/nfs/dust/cms/user/hugobg/ZPrime_102X/analysis_output/2018_CHS/muon/uhh2.AnalysisModuleRunner.DATA.*.root/AnalysisTree");
    ...
    treereco_data->Project("data_pt_leading_nominal_boosted","pT_ttbar","(ttagN>=0 && wtagN >=1 && btagN >=1 && rec_chi2 < 30 && Mttbar>900)");
    treereco_ttbar->Project("Top_pt_leading_nominal_boosted","pT_ttbar","(ttagN>=0 && wtagN >=1 && btagN >=1 && rec_chi2 < 30 && Mttbar>900)*weight*weight_sfmu_HighPtID*weight_sfmu_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew_nolimit*weight_btagdisc_central*muonrecSF_nominal");
    treereco_ttbar->Project("Top_pt_leading_up_boosted","pT_ttbar","(ttagN>=0 && wtagN >=1 && btagN >=1 && rec_chi2 < 30 && Mttbar>900)*weight*weight_sfmu_HighPtID*weight_sfmu_Trigger*weight_pu*weight_toptagSF_*weight_btagdisc_central*muonrecSF_nominal");
//    treereco_ttbar->Project("Top_pt_leading_limit_boosted","pT_ttbar","(ttagN>=0 && wtagN >=0 && btagN >=1 && rec_chi2 < 30 && Mttbar>900)*weight*weight_sfmu_HighPtID*weight_sfmu_Trigger*weight_pu*weight_toptagSF_*weight_btagdisc_central*muonrecSF_nominal*weight_pt_rew");
/*    treereco_ttbar->Project("Top_pt_leading_down_boosted","pT_ttbar","(ttagN == 1 && wtagN == 0 && btagN >=1 && rec_chi2 < 30 && Mttbar > 900)*weight*weight_sfmu_HighPtID*weight_sfmu_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew_down*weight_btagdisc_central*muonrecSF_nominal");
    treereco_ttbar->Project("Top_pt_leading_nominal_semiresolved","pT_ttbar","(ttagN == 0 && wtagN == 1 && btagN >=1 && rec_chi2 < 30 && Mttbar > 900)*weight*weight_sfmu_HighPtID*weight_sfmu_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*muonrecSF_nominal");
    treereco_ttbar->Project("Top_pt_leading_up_semiresolved","pT_ttbar","(ttagN == 0 && wtagN == 1 && btagN >=1 && rec_chi2 < 30 && Mttbar > 900)*weight*weight_sfmu_HighPtID*weight_sfmu_Trigger*weight_pu*weight_toptagSF_*weight_btagdisc_central*muonrecSF_nominal");
    treereco_ttbar->Project("Top_pt_leading_down_semiresolved","pT_ttbar","(ttagN == 0 && wtagN == 1 && btagN >=1 && rec_chi2 < 30 && Mttbar > 900)*weight*weight_sfmu_HighPtID*weight_sfmu_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew_down*weight_btagdisc_central*muonrecSF_nominal");
    treereco_ttbar->Project("Top_pt_leading_nominal_resolved","pT_ttbar","(ttagN == 0 && wtagN == 0 && btagN >=1 && rec_chi2 < 30 && Mttbar > 900)*weight*weight_sfmu_HighPtID*weight_sfmu_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew*weight_btagdisc_central*muonrecSF_nominal");
    treereco_ttbar->Project("Top_pt_leading_up_resolved","pT_ttbar","(ttagN == 0 && wtagN == 0 && btagN >=1 && rec_chi2 < 30 && Mttbar > 900)*weight*weight_sfmu_HighPtID*weight_sfmu_Trigger*weight_pu*weight_toptagSF_*weight_btagdisc_central*muonrecSF_nominal");
    treereco_ttbar->Project("Top_pt_leading_down_resolved","pT_ttbar","(ttagN == 0 && wtagN == 0 && btagN >=1 && rec_chi2 < 30 && Mttbar > 900)*weight*weight_sfmu_HighPtID*weight_sfmu_Trigger*weight_pu*weight_toptagSF_*weight_pt_rew_down*weight_btagdisc_central*muonrecSF_nominal");
*/
/*
...
//   Top_pt_leading_limit_boosted->Draw("same");
   ...
   TLegend leg(.6,.7,.8,.9,"");
   leg.AddEntry(Top_pt_leading_nominal_boosted, "t#bar{t} pT (with corrections) ","lp");
//   leg.AddEntry(Top_pt_leading_nominal_boosted, "Top_pt nominal (limit 500GeV)","lp");
   ...
   leg.AddEntry(Top_pt_leading_up_boosted,"t#bar{t} pT (no corrections)","lp");
