...
fout = TFile('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/Combine_higgs_electron_2016/'+argv[1]+'_muon_3cat.root', 'recreate')
...
for cat in categories:
    if cat == 'T1':
            ...
            for key_sample in samplelist:
                ...
                gDirectory.cd('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/Combine_higgs_electron_2016/'+argv[1]+'_muon_3cat.root:/SR1T/'+key_sample)
                if key_sample == 'DATA':
                    gDirectory.cd('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/Combine_higgs_electron_2016/'+argv[1]+'_muon_3cat.root:/SR1T/data_obs')
                    ...
                    for syst in systematic_direction_Ttbar:
                        ...
                        if syst == 'nominal':
                            ...
                            if syst=='hdampUp':
                                ...
                                je_tree.SetAlias("invmass",argv[1])
                                tempsys = TH1F("tempsys","tempsys",nb,array('d',Bin))
                                je_tree.Draw("invmass>>tempsys",cut+'*0.9')
                                print(tempsys.Integral())
                                tempsys.SetName(syst)
                                gDirectory.WriteObject(tempsys,syst)
                                del tempsys
                            if syst=='hdampDown':
                                ...
                                je_tree.SetAlias("invmass",argv[1])
                                tempsys = TH1F("tempsys","tempsys",nb,array('d',Bin))
                                je_tree.Draw("invmass>>tempsys",cut+'*0.75')
                                print(tempsys.Integral())
                                tempsys.SetName(syst)
                                gDirectory.WriteObject(tempsys,syst)
                                del tempsys
            ...
            for key_sample in samplelist:
                ...
                mytree = myfile.Get("AnalysisTree")
                mytree.SetAlias("invmass",argv[1])
                gDirectory.cd('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/Combine_higgs_electron_2016/'+argv[1]+'_muon_3cat.root:/SR0T/'+key_sample)
                if key_sample == 'DATA':
                    gDirectory.cd('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/Combine_higgs_electron_2016/'+argv[1]+'_muon_3cat.root:/SR0T/data_obs')
            ...
            for key_sample in samplelist:
                ...
                mytree = myfile.Get("AnalysisTree")
                mytree.SetAlias("invmass",argv[1])
                gDirectory.cd('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/Combine_higgs_electron_2016/'+argv[1]+'_muon_3cat.root:/CR1/'+key_sample)
                if key_sample == 'DATA':
                    gDirectory.cd('/nfs/dust/cms/user/hugobg/UHH2_v2/CMSSW_10_2_17/src/UHH2/Analysis/Combine_higgs_electron_2016/'+argv[1]+'_muon_3cat.root:/CR1/data_obs')
                    ...
                    for syst in systematic_direction_Ttbar:
                        ...
                        if syst == 'nominal':
                            ...
                            if syst=='hdampUp':
                                ...
                                je_tree.SetAlias("invmass","DeltaY")
                                tempsys = TH1F("tempsys","tempsys",nb,array('d',Bin))
                                je_tree.Draw("invmass>>tempsys",cut+'*1.22')
                                tempsys.SetName(syst)
                                gDirectory.WriteObject(tempsys,syst)
                                del tempsys
                            if syst=='hdampDown':
